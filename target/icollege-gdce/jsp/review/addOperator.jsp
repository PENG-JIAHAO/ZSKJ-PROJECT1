...
<html>
    <body>
        ...
        <c:if test="${empty cuser || cuser.getLevel() != 1}">
            <c:redirect url="/jsp/review/review.jsp"></c:redirect>
        </c:if>
        <div class='tab-content'  >
            <div class="row clearfisx" style="width:945px; margin:0;">
                <div class='tab-pane' id='add'>
                    <form action="${context }/register/addmanager" method="post" onsubmit="return ckAdminForm()">
                        <table class="child2" >
                            <tr>
                            ...
                            <tr>
                                <td >用户名:</td>
                                <td><input name="name" placeholder="输入用户名" type="text" class="inputClass" id="loginname" onBlur="ajaxsubmit()"></td>
                                <td class="tdError"><label class="errorClass" id="loginnameError">${requestScope.errors.loginname}</label></td>
                                <td align="center">邮&nbsp;&nbsp;&nbsp;&nbsp;箱：</td>
                                <td align="center"><input name="email" placeholder="输入邮箱" type="text" id="email" class="inputClass" onBlur="ajaxemail()"></td>
                               <td class="tdError"> <label class="errorClassTwo" id="emailError" >${requestScope.errors.email}</label></td>
                            </tr>
                            <tr>
                                <td>密&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
