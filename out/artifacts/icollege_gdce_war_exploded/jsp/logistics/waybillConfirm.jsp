						...
						<div class="panel panel-default">
							...
							<div class="panel-body" align="center">
								<a href="${context}/order/query?page=1" target="_self"><button
										style="width: 90px; height: 40px" class="btn btn-default"  disabled="true" id="querylist"
										type="button" onClick="showReport2()">订单查询</button></a>
							</div>
							<div class="panel-body" align="center">
								<a href="${context}/contract/querylist" target="_self"><button
										style="width: 90px; height: 40px" class="btn btn-default " disabled="true" id="queryAgreenment"
								...
								<div class="col-md-10 column">
																	...
																	<div class="modal-dialog">
																		<div class="modal-content">
																			...
																			<c:set var="waybillid" value="${waybillInfo.waybillId }"></c:set>
																				<a
																					href="${context}/logistics/changestate?state=0&
																Cstate=1&page=1&waybillId=${waybillid}">
																			...
																			<div class="modal-footer">
																				<a
																					href="${context}/logistics/query?state=0&page=1">
									...
									<div class="pull-right" style="text-align: center" id="paging">
										<ul class="pagination">
											...
											<li><a
												href="${context}/logistics/query?state=0&page=${page-1>1?page-1:1}">&laquo;</a></li>
											<c:forEach begin="1" end="${totalPages}" varStatus="loop">
												<li><a
													href="${context}/logistics/query?state=0&page=${loop.index}">${loop.index}</a>
												</li>
											</c:forEach>
											<li><a
												href="${context}/logistics/query?state=0&page=${page+1>totalPages ? totalPages:page+1}">&raquo;</a>
											</li>
										</ul>
									</div>
