...
<div class="span4" align="center">
    <h2>广告位申请二次修改</h2>
    <c:set var="advertisement" value="${sessionScope.advertisement}"></c:set>
    <div class="main-center">
        <form role="form" action="${context}/ads/updateadsmessage?id=${advertisement.id}" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="exampleInputEmail1">
                    <div align="left">
                        <p>企业机构代码<input name="companyId" type="text" class="form-control"
                                        id="name" value="${advertisement.companyId}" readonly> </p>
                        <p>
                            申请位置 <select name="position" id="position" onchange="addprice()" value="${advertisement.position}" >
                    ...
                    <p align="left">
                        投放时间 <input type="date" name="releaseDate" id="releaseDate" value="${advertisement.releaseDate}" onchange="addprice()"> 至<input
                            type="date" name="endDate" id="endDate" value="${advertisement.endDate}" onchange="addprice()">
                    </p>
                    <p>
                    <div id="price" name="price" hidden="hidden" style="color:#ff0000; size:20px" value=""></div>
                    </p>
                    <p align="left">
                        邮箱 <input name="email" type="email" class="form-control" value="${advertisement.email}"
                                  id="email" />
                    </p>
                    <p align="left">
                        ...
                        <img style="display:none"   id="image1"  height="50" width="50"
                             src="${context}/ads/loadQualificationImage?path=${ObjectUtils.defaultIfNull(advertisement.adsImgPath, '')}">
                    </p>
                    ...
                    <p align="left">
                        广告链接地址 <input name="adsURL" type="text" class="form-control" value="${advertisement.adsURL}"
                                      id="lianjie" />
                    </p>
                    ...
                    <p align="left">
                        备注<input name="note" type="text" value="${advertisement.note}" class="form-control"/>
                        <input id="price1" name="price" hidden="hidden" value="${advertisement.price}">
                    </p>

                    <p style="display: flex;justify-content: space-around;">
                        <input type="submit" id="submit"  class="btn btn-primary" />
                        <%--							<button type="button" id ="test" onClick ="submitcon()" >提交</button>--%>
                        <button type="button"   class="btn btn-primary"><a style="color: #FFFFFF;" href="${context}/ads/queryAdvertisement?reviewState=2">返回</a></button>
                    </p>
                </label>
            </div>
        </form>
