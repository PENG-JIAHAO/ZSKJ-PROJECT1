                            ...
                            <table class="child2" >
                                ...
                                <tr>
                                    ...
                                    <td class="tdError"> <label
                                            class="errorClass" id="emailError" >${requestScope.errors.email}</label>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><label> <select
                                            name="department" id="department" class="inputClass">
                                ...
                                <tr>
                                    ...
                                    <td align="center"><label> <select name="permission"
                                                                       id="permission" class="inputClass">
                                ...
                                <tr>
                                    <td align="center" class="child2-button" ><label> <input name="submit"
                                            type="submit" name="Submit" value="提交" style="background-color: #3cd0f3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
                                            name="reset" type="reset" id="reset" value="返回" style="background-color: #808080">
                                    </label></td>
                                </tr>
                            </table>
                        </form>
