                ...
                <div class="row">
                    ...
                    <div class="span12">
                        ...
                        <div class="row" style="height: 50px;">
                            ...
                            <div class="col-md-offset-1 col-md-8" align="left">
                        ...
                        <div class="row" style="height: 45px;">
                            <div class="col-md-offset-1 col-md-12" align="left">
                                <b>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</b>
                        ...
                        <div class="row" style="height: 70px;">
                            <div class="col-md-offset-1 col-md-10" align="left" style="margin-top: -10px">
                                <b>企&nbsp;业&nbsp;类&nbsp;型：</b> <input type="radio" name="permission" id="permission"
                                                                      value="1" checked="checked"/>采购方 &nbsp;&nbsp;
                                <input type="radio" name="permission" id="permission" value="2"/>供应商&nbsp;&nbsp;
                                <input type="radio" name="permission" id="permission" value="3"/>物流&nbsp;&nbsp;
                            </div>
                            <br>

                            <div class="row" style="zheight: 50px;">
                                <div class="col-md-offset-1 col-md-10" align="left" style="margin-top: 25px">
                                    <b>&nbsp;&nbsp;&nbsp;验&nbsp;&nbsp;&nbsp;证&nbsp;&nbsp;&nbsp;码：</b> <input
                            ...
                            <div class="row" style="height: 60px;float: left;margin-left: 90px;margin-top: -41px">
                                <div class=" col-md-3 col-md-offset-6" align="left" id="divVerifyCode"
                                     style="width: 250px;">
                                    <img id="imgVerifyCode"
                                         style="width: 85px; height:30px; margin-top: -10px; margin-left: -50px"
                                         src="<c:url value='/verifyCode'/>"/>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a id="another" style="width: 50px;height: 30px" href="javascript:_hyz()">换一张</a>
                                </div>
                            </div>
                            <br>
                            <div class="row" style="height: 50px;">
                                <div class="col-md-offset-3 col-md-8" style="float: left;margin-left: 160px">
                                    <input name="submit" type="submit" id="submit" value="确定" class="btn btn-primary">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="reset" name="rest" value="重置" class="btn btn-primary">
                                </div>
                            </div>
                            <div class="col-md-offset-4 col-md-8" align="left" style="margin-top: 40px">
