...
<script type="text/javascript">
    ...
    function judge() {
        var pass = "${currentUser.permission eq '3' ? 1 : 2}";
        if (pass == 1) {
        ...
        <nav class="navbar">
            <ul class="nav nav-pills pull-right socials">
                ...
                <li role="presentation"><a
                        href="${context}/news/findPageBean?type=hgzc&&currentPage=1">资讯中心</a>
                </li>
                ...
                <div class="col-md-10 column">
                    <div
                        ...
                        <ul class="nav nav-tabs">
                            <li><a href="${context}/jsp/contract/contractEnsure.jsp">待签</a></li>
                            <li class="active"><a href="${context}/jsp/contract/bothSigned.jsp">历史</a></li>
                                                        <form role="form"
                                                              action="${context }/contract/queryAppointedContract?a=2"
                                                              method="post">
                                                            <li>
                                                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                                                                <input type="number" class="form-horizontal;" id="contractNumber" name="contractId" a="2"
                                                                       placeholder="请输入合同编号">
                                                                &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <c:choose>
                        <c:when test="${ hasResult==true }">
                            <c:forEach var="contract" items="${contracts}">
                                <c:if test="${contract.buyerContractState eq true && contract.sellerContractState eq true }">
                                    <div
                                        ...
                                        <div
                                            ...
                                            <p id="ctrId">
                                                合同编号：${contract.contractId}</p>
                                        </div>
                                        <div style="padding-left: 20px">
                                            <p style="padding-top: 8px">
                                                买方公司编号：${contract.buyerCompanyId}</p>
                                            <p>
                                                卖方公司编号：${contract.sellerCompanyId}</p>
                                            <p>
                                                商品编号：${contract.productId}</p>
                                            <p>
                                                创建时间：${contract.createDate}</p>
                                            <p>
                                                结束时间：${contract.endDate}</p>
